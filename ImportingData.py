        ...
        while end_date != start_date and nextstep == "yes":
            ...
            try:
                ...
                while camera_number == 1 and nextstep == "yes":
                    ...
                    # Runs if the zones do not have directional descriptors
                    if df1["Zone Name"].str[0:2][0] != direction_list[camera_number-1]:
                        df1["Zone Name"] = direction_list[camera_number-1] + df1["Zone Name"]
            ...
            try:
                while camera_number < 5 and nextstep == "yes":
                    ...
                    # Runs if the zones do not have directional descriptors
                    if df2["Zone Name"].str[0:2][0] != direction_list[camera_number-1]:
                        df2["Zone Name"] = direction_list[camera_number-1] + df2["Zone Name"]
